...
using WizardToolsOverpowered.Types;
using WizardToolsOverpowered.Utils;

namespace WizardToolsOverpowered
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //string str = File.ReadAllText(@"D:\DevProjects\WorkFriendly\WizardToolsOverpowered\WizardToolsOverpowered\WizardXML\Wizard_structured.xml", Encoding.UTF8);
    ...
    object TSBHer
      Value = 123
            ...
            string wholeWizard = File.ReadAllText(@"D:\DevProjects\WorkFriendly\WizardToolsOverpowered\WizardToolsOverpowered\WizardDataExamples\Wizard22.txt");
